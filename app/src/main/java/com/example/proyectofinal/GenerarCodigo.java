...
public class GenerarCodigo extends AppCompatActivity implements View.OnClickListener {
        ...
        public ArrayList<String> convertirBloques(String textoClaro, int bloques) {
            ...
            // creamos la variable  en el las se almacena en grupos
        ...
        public ArrayList<String> permutacion(ArrayList<String> cadenaSustituida) {
            ...
            for (String n : ltPermutacion) {
                System.out.println("Permutación" + n);
            }
        ...
        public ArrayList<String> permutacionDeco(ArrayList<String> cadenaSustituida) {
            ...
            for (int i = 0; i < cadenaSustituida.size(); i = i + 2) {
                ...
                while (contador < cadenaSustituida.get(i).length()) {// System.out.println("Valor de I: " + i);
                    int pos =
                            Integer.parseInt(String.valueOf(orden.charAt(contador)));
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == R.id.btnAceptar) {
                ...
                itam_bloq = Integer.parseInt(tamBloque.getText().toString());
                {
                    ...
                    if (itam_bloq % 2 == 0) { //verifcar si el tamaño es par
                        ...
                        if (permutacion.getText().length() == (itam_bloq / 2)) {
                            ...
                            permutacion.setError("Debe ser la mitad del tamaño");
                            permutacion.requestFocus();
                        }
                        int rep = 0;
                        ...
                        tamBloque.setError("Solo números pares");
